...
export default function PortfolioProject() {
    ...
    const features = [
        {
            title: t('projects.items.portfolio.features.design.title'),
            description: t('projects.items.portfolio.features.design.desc'),
            icon: "✨"
        },
        {
            title: t('projects.items.portfolio.features.interactivity.title'),
            description: t('projects.items.portfolio.features.interactivity.desc'),
            icon: "🎮"
        },
        {
            title: t('projects.items.portfolio.features.media.title'),
            description: t('projects.items.portfolio.features.media.desc'),
            icon: "🎵"
        },
        {
            title: t('projects.items.portfolio.features.architecture.title'),
            description: t('projects.items.portfolio.features.architecture.desc'),
            icon: "🏗️"
        }
    ];

    const techStack = [
        "React", "Vite", "Tailwind CSS", "Framer Motion", "React Router", "Spotify Web API"
    ];
        ...
        <section className="py-12 max-w-5xl mx-auto px-4">
            <div className="mb-12">
                ...
                <p className="text-zinc-400 text-lg max-w-3xl">
                    {t('projects.items.portfolio.description_extended')}
                </p>
            </div>

            {/* Stack Tecnológico */}
            <div className="mb-16">
                <h2 className="text-xl font-semibold mb-6">{t('projects.items.portfolio.tech_stack')}</h2>
            ...
            <div className="rounded-3xl overflow-hidden border border-zinc-800 shadow-2xl bg-zinc-900 p-2">
                <div className="bg-zinc-950 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
                    ...
                    <h2 className="text-2xl font-bold mb-6 relative z-10">{t('projects.items.portfolio.philosophy_title')}</h2>
                    <p className="text-zinc-400 max-w-2xl mx-auto mb-8 relative z-10">
                        {t('projects.items.portfolio.philosophy_desc')}
                    </p>
            ...
            <div className="mt-16 text-center">
                <a
                    href="https://github.com/XesusGarcia1/portfolio-xesus"
                    target="_blank"
                ...
                >
                    ...
                    {t('projects.items.portfolio.view_github')}
                </a>
            </div>
        </section>
    )
